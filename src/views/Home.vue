        ...
        .row.g-0
          ...
          .col-xl-6.info-section
            .content-wrapper.px-lg-4.pt-lg-4.px-xxl-5.py-xxl-5.text-start
              ...
              p.descripcion.mb-4 La unidad sobre el ciclo de las políticas públicas, examina sus fases: puesta en agenda, diseño, planificación, formulación, implementación, monitoreo y evaluación. Analiza cómo los problemas sociales se convierten en prioridades estatales y cómo se diseñan respuestas viables, estratégicas y sostenibles. Resalta la importancia de la participación ciudadana, el uso de evidencia para decisiones públicas y la adaptación al contexto. Además, subraya el papel del monitoreo y evaluación como herramientas para mejorar la eficacia y legitimidad de las políticas, promoviendo una gestión pública más justa, eficiente y orientada al bienestar colectivo.
